...
public class DriverOI {
    public DriverOI(
        ...
        oi.addRule(Rule.create(
                        "Reset Pos", () -> leftJoystick.getButton(InputConstants.BUTTON_RESET_POS))
        ...
        oi.addRule(Rule.create(
                        ...
                        new Conditions.Toggle(
                                () -> rightJoystick.getButton(InputConstants.BUTTON_CROSS_WHEELS)))
                .withOnTriggeringProcedure(
                        ONCE_AND_HOLD,
                        Set.of(drive),
                ...
                .withOnTriggeringProcedure(REPEATEDLY, Set.of(drive), () -> {
                    ...
                    final double drivingCoefficient =
                            rightJoystick.getButton(InputConstants.BUTTON_FINE_DRIVING)
                                    ...
                                    : 1;
                    drive.setRequest(new SwerveDrive.FieldOrientedVelocity(
                            (drivingCoefficient
                                    * curvedJoystickPower(
                                            leftJoystickX,
