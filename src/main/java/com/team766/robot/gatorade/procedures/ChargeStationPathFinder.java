...
public class ChargeStationPathFinder {
        ...
        switch (alliance) {
            case Red:
                ...
                addPoints(
                        ...
                        curX,
                        curY,
                        ChargeConstants.RED_BALANCE_TARGET_X,
                        ChargeConstants.RED_LEFT_PT,
                        ChargeConstants.RED_RIGHT_PT,
                        ChargeConstants.MIDDLE);
                break;
            ...
            case Blue:
                ...
                addPoints(
                        ...
                        curX,
                        curY,
                        ChargeConstants.BLUE_BALANCE_TARGET_X,
                        ChargeConstants.BLUE_LEFT_PT,
                        ChargeConstants.BLUE_RIGHT_PT,
                        ChargeConstants.MIDDLE);
                break;
            default:
    ...
    private void addPoints(
            ...
            double right,
            double height) {
        // If on the right side of the target, check if robot is blocked by the right side of the
        // charge station, and add points accordingly
        if (curX > target) {
            if (curX < right) points.add(new PointDir(right, curY));

            points.add(new PointDir(right, height));

            // Otherwise, it will be on the left side of the target, so check if robot is blocked by
            // the left side of the charge station, and add points accordingly
        } else {
            if (curX > left) points.add(new PointDir(left, curY));
