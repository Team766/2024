...
public class Center1235VisionAuto extends PathSequenceAuto {
    public Center1235VisionAuto() {
		...
		addPath("Start Center Subwoofer, Get Center Wing, End Center Wing");
		addProcedure(new ShootNow());

		addProcedure(new StartAutoIntake());
		addPath("Start Center Wing, Get Center Amp Midfield, End Center Wing");
		addProcedure(new ShootNow());

		addProcedure(new StartAutoIntake());
		addPath("Start Center Wing, Get Source Wing, End Center Wing");
		addProcedure(new ShootNow());

		addProcedure(new StartAutoIntake());
		addPath("Start Center Wing, Get Amp Wing, End Center Wing");
		addProcedure(new ShootNow());
    }
}