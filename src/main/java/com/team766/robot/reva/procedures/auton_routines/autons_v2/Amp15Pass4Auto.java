...
public class Amp15Pass4Auto extends PathSequenceAuto {
	public Amp15Pass4Auto() {
		...
		addProcedure(new StartAutoIntake());
		addPath("Start Amp Subwoofer, Get Amp Midfield, End Passing Spot Amp Midfield");
		addProcedure(new ShootVelocityAndIntake(1500));

		addProcedure(new StartAutoIntake());
		addPath("Start Passing Spot Amp Midfield, Get Center Amp Midfield, End Amp Subwoofer");
		addProcedure(new ShootAtSubwoofer());
	}
