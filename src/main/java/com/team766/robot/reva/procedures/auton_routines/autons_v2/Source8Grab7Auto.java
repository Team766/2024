...
public class Source8Grab7Auto extends PathSequenceAuto {
    public Source8Grab7Auto() {
		...
		addPath("Start Source Subwoofer, Get Source Midfield, End Source Subwoofer");
		addProcedure(new ShootAtSubwoofer());

        addProcedure(new StartAutoIntake());
		addPath("Start Source Subwoofer, Get Center Source Midfield, Retreat By Stage");
    }
}