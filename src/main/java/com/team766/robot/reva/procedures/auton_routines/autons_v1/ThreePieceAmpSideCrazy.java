package com.team766.robot.reva.procedures.auton_routines.autons_v1;
...
public class ThreePieceAmpSideCrazy extends PathSequenceAuto {
    public ThreePieceAmpSideCrazy() {
		...
		addPath("amp side corner pick-up top-mid-note shoot center");
		addProcedure(new ShootNow());
		addProcedure(new StartAutoIntake());
		addPath("grab center-mid-note shoot center");
		addProcedure(new ShootNow());
		addPath("go mid field from shoot center");
    }
}
