...
public class Amp15Grab4Auto extends PathSequenceAuto {
	public Amp15Grab4Auto() {
		...
		addProcedure(new StartAutoIntake());
		addPath("Start Amp Subwoofer, Get Center Amp Midfield, End Amp Subwoofer");
		addProcedure(new ShootAtSubwoofer());

		addProcedure(new StartAutoIntake());
		addPath("Start Amp Subwoofer, Get Amp Midfield, End Amp Midfield");
	}
