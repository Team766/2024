...
public abstract class VisionPIDProcedure extends Procedure {
     ...
     */
    private static AnywhereScoringPosition aa1 = new AnywhereScoringPosition(1.237, 5400, 17.343);
    private static AnywhereScoringPosition a1 = new AnywhereScoringPosition(1.453, 5400, 17.80599);
    private static AnywhereScoringPosition a2 =
            new AnywhereScoringPosition(1.7201, 5400, 22.205946);
    private static AnywhereScoringPosition a3 = new AnywhereScoringPosition(1.9506, 5400, 23.516);
    private static AnywhereScoringPosition a4 = new AnywhereScoringPosition(2.072, 5400, 27.32);
    private static AnywhereScoringPosition a5 = new AnywhereScoringPosition(2.29161, 5400, 31.109);
    private static AnywhereScoringPosition a6 = new AnywhereScoringPosition(2.4616, 5400, 31.8987);
    private static AnywhereScoringPosition a7 = new AnywhereScoringPosition(2.6942, 5400, 32.699);
    private static AnywhereScoringPosition a8 =
            new AnywhereScoringPosition(2.8657, 5400, 34.103733);
    private static AnywhereScoringPosition a9 = new AnywhereScoringPosition(3.2926, 5400, 34.6842);
