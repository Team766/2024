    ...
    public BoxOpOI(
        ...
        oi.addRule(Rule.create(
                ...
                .withOnTriggeringProcedure(
                        ...
                        ONCE, Set.of(ss), () -> ss.setRequest(Shoulder.RotateToPosition.TOP))
                .whenTriggering(
                        // if the sticks are being moving, move the corresponding climber(s)
                        Rule.create(
                                        "Move climbers",
                                        () -> gamepad.isAxisMoved(InputConstants.XBOX_LS_Y)
                                                || gamepad.isAxisMoved(InputConstants.XBOX_RS_Y))
                                .withOnTriggeringProcedure(REPEATEDLY, Set.of(ss), () -> {
                                    boolean overrideSoftLimits =
                                            gamepad.getButton(InputConstants.XBOX_X)
                                                    && gamepad.getButton(InputConstants.XBOX_Y);
                                    ss.setRequest(new Climber.MotorPowers(
                ...
                .whenNotTriggering(
                        Rule.create(
                                ...
                                .withOnTriggeringProcedure(
                                        ...
                                        Set.of(ss),
                                        () -> ss.setRequest(
                                                Shoulder.RotateToPosition.INTAKE_FLOOR)),
                        Rule.create(
                                ...
                                .withOnTriggeringProcedure(
                                        ONCE,
                                        Set.of(ss),
                                        () -> ss.setRequest(Shoulder.RotateToPosition.SHOOT_LOW)),
                        Rule.create(
                        ...
                        Rule.create(
                                ...
                                .withOnTriggeringProcedure(
                                        ...
                                        Set.of(ss),
                                        () -> ss.setRequest(
                                                Shoulder.RotateToPosition.SHOOTER_ASSIST))
        ...
        // shooter
        oi.addRule(Rule.create("Spin Shooter", () -> gamepad.getAxis(InputConstants.XBOX_RT) > 0)
                .withOnTriggeringProcedure(
                        ONCE_AND_HOLD,
                        Set.of(shooter),
        ...
        // intake
        oi.addRule(Rule.create("Intake Out", () -> gamepad.getButton(InputConstants.XBOX_RB))
                .withOnTriggeringProcedure(
                        ONCE_AND_HOLD, Set.of(intake), () -> intake.setRequest(new Intake.Out())));
        oi.addRule(Rule.create("Intake Until In", () -> gamepad.getButton(InputConstants.XBOX_LB))
